...
-   Other methods like knnImpute or BagImpute or even some models which
    ...
    predictors are directly relating predictors with missing NA.
...
more people in Pclass 3 than Pclass 1 and 2.
...
same ticket and family name. (A + B - C)
...
![](Figures/README-unnamed-chunk-27-2.png) Some pattern but not really
clear.
